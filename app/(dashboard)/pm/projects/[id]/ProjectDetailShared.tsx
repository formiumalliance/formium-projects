// app/(dashboard)/pm/projects/[id]/ProjectDetailShared.tsx
// Shared server component used by all portals' project detail pages
...
export default async function ProjectDetailShared({ projectId, portalBase }: Props) {
  ...
  const tasksByPhase = project.tasks.reduce((acc: Record<string, typeof project.tasks>, task) => {
    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: '24px', maxWidth: '1200px' }}>
      ...
      <div>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', gap: '16px' }}>
          ...
          <ProjectActionsClient project={project} portalBase={portalBase} />
        </div>
      </div>
      ...
      >
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
          ...
          <Link
            href={`${portalBase}/projects/${project.id}/tasks/new`}
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '14px' }}>
          ...
          <div className="card" style={{ padding: '16px' }}>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '12px' }}>
              ...
              <Link href={`${portalBase}/projects/${project.id}/team`} style={{ fontSize: '12px', color: 'var(--accent)' }}>
                Manage
              </Link>
            </div>
